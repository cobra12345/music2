...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      ...
      const supportServerLink = "https://discord.gg/miqiling";
      const githubLink = "https://discord.gg/miqiling";
      const replitLink = "https://discord.gg/miqiling";
      const youtubeLink = "https://discord.gg/miqiling";
